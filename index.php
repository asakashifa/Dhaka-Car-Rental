                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: white">DHAKA CAR RENTAL</h1>
                            <p class="intro-text">
...
<br>
        <section class="menu-content">
            ...
            <h6> AC Fare: <?php echo ("TK" . $ac_price . "/km & TK" . $ac_price_per_day . "/day"); ?></h6>
            <h6> Non-AC Fare: <?php echo ("TK" . $non_ac_price . "/km & TK" . $non_ac_price_per_day . "/day"); ?></h6>
        ...
        <div class="w3-row w3-padding-32 w3-section">
            ...
            <div class="w3-col m8 w3-panel">
                <div class="w3-large w3-margin-bottom">
                    ...
                    <i class="fa fa-phone fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Phone: +88001956789415<br>
                    <i class="fa fa-envelope fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Email: dhaka_car_rental@gmail.com<br>
                </div>
